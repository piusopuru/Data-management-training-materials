...
#result is p=0.5948 hence not significant thus no relationship

#Exercise:2.using agric_gender data, ttest on gender vs yield_tonnes

t.test(yield_tonnes~ gender, data = agric_gender)

#p-value = 0.0137 hence significant thus there is relationship
...
wilcox.test(Pesticid ~ location, data = agriculture)
